...
const messages = ref([
  { role: "assistant", content: "I’m your expense tracker. Ask me to add an expense or total your coffee spend this month." },
]);
const input = ref("");
...
function resetChat() {
  messages.value = [{ role: "assistant", content: "I’m your expense tracker. Ask me to add an expense or total your coffee spend this month." }];
  input.value = "";
  errorMessage.value = "";
...
async function loadMessages(id) {
  try {
    ...
    if (!res.error) {
      ...
      if (messages.value.length === 0) messages.value = [{ role: "assistant", content: "I’m your expense tracker. Ask me to add an expense or total your coffee spend this month." }];
    }
  } finally {
